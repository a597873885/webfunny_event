...
var fs = require('fs');
stat = fs.stat;
delDir("./views/webfunny_event")
fs.mkdir( "./views/webfunny_event", function(err){
  if ( err ) { 
...
// 生成探针结束
copy("./views/resource/", "./views/webfunny_event")
copy("./views/images/", "./views/webfunny_event")
console.log("= 正在执行编译，请稍等...")
setTimeout(function() {
  let path = './views/webfunny_event/js';
